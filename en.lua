translations.en = {
	...
	-- Valentine Event
	val_event_name = "Valentine's Day",
	val_welcome = "<BV><b>♥ The sky glows with a pink shimmer today, Cupid wanders around... Want to say hello to him? A little kiss is enough! ♥</b></BV>",
	val_wait = "<ROSE>Searching for the owner of the mysterious envelope... Please wait.",
	val_mission = "<ROSE>Deliver this mysterious envelope to <V>%s</V>!",
	val_mission_solo = "<ROSE>It seems you are alone... Maybe shedding some <u><b>tears</b></u> could help?",
	val_mission_start = "<ROSE>♥ Your heart now glows with a pink shimmer! Complete the map and claim Cupid's special gift! ♥",
	val_welcome_craft = "<BV><b>Cupid watches over this place. Bring your gifts to the Fountain of Love and seal your bond forever!</b>",
	val_chain_complete = "<ROSE>♥ The mysterious envelope has safely reached its owner. Thank you for your help! ♥",
	val_reward = "<ROSE>♥ Great job! Here's a reward for your help with the envelope delivery: <J>%s",
	val_reward_solo = "<ROSE>♥ What a performance! Cupid was watching and he's impressed. Take this gift filled with whispers of love: <J>%s ♥",
	val_collect_hint = "<CE>Now head to <b><u>/room #parkour0valentine</u></b> to transform your collected materials into a special surprise!",
	val_village_hint = "<CE>Congratulations! Now head to <b><u>/room #parkour0village</u></b> to use your crafted rings for exclusive rewards!",
	
	-- Materials
	mat_rose = "Rose",
	mat_ribbon = "Ribbon",
	mat_chocolate = "Chocolate",
	mat_envelope = "Letter",
	val_fountain_reset = "<R>The fountain has been cleared, and your materials have been returned to your inventory.",
	val_gift_send = "<ROSE>♥ You've gifted <V>%s</V> a <J>%s</J>!",
	val_gift_receive = "<ROSE>♥ <V>%s</V> sent you a <J>%s</J>! How kind of them.",
	val_craft_success = "<ROSE>♥ Congratulations! You combined the materials to craft a <J>Ring</J>!",
	val_material_limit = "has reached the maximum limit for this material!",
	
	-- UI
	val_ui_gifting_title = "HEART MAIL",
	val_ui_item_selection = "SELECT ITEM",
	val_ui_target_selection = "SELECT RECIPIENT",
	val_ui_gift_button = "Send Gift",
	val_ui_confirm_text = "Are you sure you want to send a <J>%s</J> to <V>%s</V>?",
	val_ui_reset = "RESET",
	val_ui_finish = "FINISH",
	val_ui_yes = "YES",
	val_ui_no = "NO",
	val_ui_selection_needed = "MAKE SELECTION",
	val_ui_warning = "WARNING!",
	val_ui_add_all = "ADD ALL",
	val_ui_remove_all = "REMOVE ALL",
	val_insufficient_materials = "<ROSE>♥ <V>%s</V>, you don't have enough materials in your bag to craft a ring yet! ♥",
	val_all_selected = "<ROSE>♥ <V>%s</V>, the love fountain is bubbling! All materials are ready to be blended with love! ♥",
	val_crafted = "<ROSE>♥ Congratulations <V>%s</V>! You've successfully crafted <J>%s</J> Ring(s) by combining the materials! ♥",
}
