translations.tr = {
	...
	-- Valentine Event
	val_event_name = "Sevgililer Günü",
	val_welcome = "<BV><b>♥ Gökyüzü bugün pembe bir ışıltıyla parlıyor, Cupid etrafta dolaşıyor... Ona selam vermek ister misin? Küçük bir öpücük yeter! ♥</b></BV>",
	val_wait = "<ROSE>Gizemli zarfın sahibi aranıyor... Lütfen bekleyin.",
	val_mission = "<ROSE>Bu gizemli zarfı <V>%s</V> adlı oyuncuya teslim et!",
	val_mission_solo = "<ROSE>Görünüşe göre şu an yalnızsın... Belki de biraz <u><b>gözyaşı</b></u> dökmek iyi gelebilir?",
	val_mission_start = "<ROSE>♥ Kalbin şimdi pembe bir ışıltıyla parlıyor! Haritayı bitir ve Cupid'in hazırladığı özel hediyeyi kazan! ♥",
	val_welcome_craft = "<BV><b>Cupid burayı izliyor. Hediyelerini aşk çeşmesine getir ve bağını sonsuza dek mühürle!</b>",
	val_chain_complete = "<ROSE>♥ Gizemli zarf güvenli bir şekilde sahibine ulaştı. Yardımların için teşekkürler! ♥",
	val_reward = "<ROSE>♥ Harika iş! Zarf teslimatındaki yardımın için ödülün: <J>%s",
	val_reward_solo = "<ROSE>♥ Harika bir performans! Cupid seni izliyordu ve çok etkilendi. Aşk fısıltılarıyla dolu bu hediyeyi al: <J>%s ♥",
	val_collect_hint = "<CE>Şimdi <b><u>/room #parkour0valentine</u></b> odasına giderek topladığın malzemeleri özel bir sürprize dönüştürebilirsin!",
	val_village_hint = "<CE>Tebrikler! Şimdi <b><u>/room #parkour0village</u></b> odasına giderek ürettiğin yüzükleri özel ödüller için kullanabilirsin!",
	
	-- Materials
	mat_rose = "Gül",
	mat_ribbon = "Kurdele",
	mat_chocolate = "Çikolata",
	mat_envelope = "Mektup", -- Item name remains Mektup? Or should it be Zarf? The user said "mektup zaten topladığımız objelerden biri". 
	val_fountain_reset = "<R>Fıskiye temizlendi, kullanılan malzemeler çantana geri döndü.",
	val_gift_send = "<ROSE>♥ <V>%s</V> adlı oyuncuya bir adet <J>%s</J> hediye ettin!",
	val_gift_receive = "<ROSE>♥ <V>%s</V> sana bir <J>%s</J> gönderdi, ne nazik bir hareket!",
	val_craft_success = "<ROSE>♥ Tebrikler! Malzemeleri birleştirerek bir <J>Yüzük</J> ürettin!",
	val_material_limit = "bu malzeme için maksimum limite ulaştı!",
	
	-- UI
	val_ui_gifting_title = "GÖNÜL POSTASI",
	val_ui_item_selection = "EŞYA SEÇİMİ",
	val_ui_target_selection = "ALICI SEÇİMİ",
	val_ui_gift_button = "Hediye Gönder",
	val_ui_confirm_text = "<V>%s</V> adlı oyuncuya bir adet <J>%s</J> göndermek istediğine emin misin?",
	val_ui_reset = "SIFIRLA",
	val_ui_finish = "BİTİR",
	val_ui_yes = "EVET",
	val_ui_no = "HAYIR",
	val_ui_selection_needed = "SEÇİM YAPIN",
	val_ui_warning = "DİKKAT!",
	val_ui_add_all = "HEPSİNİ EKLE",
	val_ui_remove_all = "HEPSİNİ ÇIKAR",
	val_insufficient_materials = "<ROSE>♥ <V>%s</V>, çantanızda henüz bir yüzük oluşturacak kadar malzeme yok! ♥",
	val_all_selected = "<ROSE>♥ <V>%s</V>, aşk çeşmesi fokurduyor! Tüm malzemeler sevgiyle harmanlanmaya hazır! ♥",
	val_crafted = "<ROSE>♥ Tebrikler <V>%s</V>! Malzemeleri birleştirerek başarıyla <J>%s</J> adet Yüzük ürettin! ♥",
}
